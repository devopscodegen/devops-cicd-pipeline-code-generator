...
from devops_cicd_pipeline_code_generator.orchestrators import CICDPipelineOrchestrator

class CICDPipelineCodeGeneratorChain:
    """
    PLACEHOLDER
    """
    ...
    def __init__(
        ...
        cicd_pipeline_orchestrator: CICDPipelineOrchestrator = CICDPipelineOrchestrator.JENKINS,
        chain: Runnable = None,
    ):
        self.set_llm(llm)
        self.set_source_code_repository(source_code_repository)
        self.set_cicd_pipeline_orchestrator(cicd_pipeline_orchestrator)
    ...
    def get_cicd_pipeline_orchestrator(self) -> CICDPipelineOrchestrator:
        """Get CI/CD pipeline orchestrator"""
        return self.cicd_pipeline_orchestrator

    def set_cicd_pipeline_orchestrator(self, cicd_pipeline_orchestrator: CICDPipelineOrchestrator = None):
        """Set CI/CD pipeline orchestrator"""
        self.cicd_pipeline_orchestrator = cicd_pipeline_orchestrator
    ...
    def route_to_generate_container_image_code_chain(self, info: dict = None):
        ...
        return CICDPipelineCodeGeneratorChainForMiddleware(
            llm=llm,
            source_code_repository=SourceCodeRepository(
                language=language,
                dependency_management_tool=dependency_management_tool,
